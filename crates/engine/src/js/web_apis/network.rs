use crate::js::common::{is_callable, noop, with_host_mut};
use crate::js::web_apis::encoding::make_array_buffer_from_value;
use crate::js::{JsFetchCapability, JsFetchRequest, JsFetchResponse};
