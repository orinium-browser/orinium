...
use crate::layouter::types::{Color, TextFlowStyle, TextStyle};
use crate::platform::audio::SoundManager;
use crate::renderer_model::{Brush, DrawCommand, FillRule, Image, Paint, rect_path};
use crate::ui::custom_node::{ContentSize, CustomNode, PointerEvent};
...
fn solid_fill(path: crate::renderer_model::Path, color: Color) -> DrawCommand {
    DrawCommand::Fill {
        path,
        paint: Paint {
