...
use engine::layouter::types::{
    Color, ColorStop, Gradient, GradientKind, LineHeight, RadialShape, RadialSizeKind,
    TextFlowStyle, TextStyle,
};
use engine::renderer_model::{AffineTransform, Brush, DrawCommand, Image, Paint, Path, Rect};
...
mod tests {
    use super::*;
    use engine::renderer_model::{ellipse_path, rect_path, rounded_rect_path};
    ...
    fn solid_fill(path: Path, color: Color) -> DrawCommand {
        DrawCommand::Fill {
            ...
            rule: engine::renderer_model::FillRule::NonZero,
        }
    }
